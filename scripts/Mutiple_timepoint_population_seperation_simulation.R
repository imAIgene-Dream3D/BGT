...
population_separation_simulation("~/Desktop/working folder/NaPo_bgt/13T_processing/Test", "~/Desktop/working folder/NaPo_bgt/13T_processing/classified_tcell_track_data.rds", 4, c(86, 95), 30)
