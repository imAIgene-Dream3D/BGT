...
#pars = yaml.load_file("/demos/behavioral_transcriptions_demo/BEHAV3D_config.yml")
  
scRNA_seq_dataset<-readRDS("~/Desktop/working folder/10T_data_processsing/Transcriptomics/scRNA_seq_dataset.rds")
CD8_behav<-read.csv("~/Desktop/working folder/10T_data_processsing/Transcriptomics/CD8_engagement_behavior_freq.csv")

main_output_dir="~/Desktop/working folder/10T_data_processsing/Transcriptomics"
output_dir=paste0(main_output_dir,"/results/")
