...
output_dir=paste0(BGT_dir, "Results/Module3/")
...
### Select cells at timepoint "around t2 hours" and remove cluster 1 since in the real experiment dead cells are excluded by FACS
